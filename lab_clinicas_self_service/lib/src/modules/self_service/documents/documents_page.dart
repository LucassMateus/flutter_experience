...
import 'package:lab_clinicas_self_service_cb/src/modules/self_service/documents/widgets/document_box_widget.dart';
...
class _DocumentsPageState extends State<DocumentsPage> with MessagesViewMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final totalHealthInsuresCard =
        documents?[DocumentType.healthInsureCard]?.length ?? 0;
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Row(
                    children: [
                      DocumentBoxWidget(
                        uploaded: totalHealthInsuresCard > 0,
                        icon: Image.asset('assets/images/id_card.png'),
                        label: 'CARTEIRINHA',
                        totalFiles: totalHealthInsuresCard,
                        onTap: () async {
                ...
                const SizedBox(height: 24),
                Visibility(
                  visible: totalMedicalOrder > 0 && totalHealthInsuresCard > 0,
                  child: Row(
                    children: [
                      Expanded(
